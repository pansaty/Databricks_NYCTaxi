...
// This is just for identification throughout the notebooks rather than hardcoding "nyctaxi" in many places
val appName = "nyctaxi"

// These are folder names for folders under the mount points (see 01-AzureStorage). They correspond to the containers used in this version of the workshop.
val source = "source"
